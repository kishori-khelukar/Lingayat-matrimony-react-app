  ...
  const handleSearchUsers = (event) => {
    ...
    if (text) {
      const filtered = UserData.filter(
        () => UserData.age.toLowerCase().includes(text.toLowerCase()),
        UserData.marriedStatus.toLowerCase().includes(text.toLowerCase()),
        UserData.gender.toLowerCase().includes(text.toLowerCase())
      );
                  ...
                  <div className="w3_regular_search">
                    <form action="#" method="post">
                      ...
                      <div className="form_but1">
                        <label
                          className="col-sm-5 control-label1"
                          htmlFor="sex"
                        >
                          Gender :{" "}
                        </label>
