        ...
        <div className="container">
          ...
          <div className="col-md-9 profiles-list-agileits">
            ...
            <div id="parentHorizontalTab">
              ...
              <div className="resp-tabs-container hor_1">
                <div>
                  <div className="w3_regular_search">
                    <form action="#" method="post">
                      <div className="form_but1">
                        <label className="col-sm-5 control-label1" for="sex">
                          Gender :{" "}
                        </label>
                      ...
                      <div className="form_but1">
                        ...
                        <div className="w3agile__text col-sm-7 w3agile_banner_btom_login_left1">
                          <select
                            id=""
                          ...
                          >
                            ...
                            <option value="null">44</option>
                            <option value="null">45</option>
                            <option value="null">46</option>
                            <option value="null">47</option>
                            <option value="null">48</option>
                            <option value="null">49</option>
                            <option value="null">50</option>
                            <option value="null">51</option>
                            <option value="null">52</option>
                            <option value="null">53</option>
                          </select>
                          <span>To </span>
                          <select
                            id=""
                          ...
                          >
                            ...
                            <option value="null">52</option>
                            <option value="null">53</option>
                            <option value="null">54</option>
                            <option value="null">55</option>
                            <option value="null">56</option>
                            <option value="null">57</option>
                            <option value="null">58</option>
                            <option value="null">59</option>
                            <option value="null">60</option>
                            <option value="null">61</option>
                            <option value="null">62</option>
                            <option value="null">63</option>
                            <option value="null">64</option>
                            <option value="null">65</option>
                            <option value="null">66</option>
                            <option value="null">67</option>
                            <option value="null">68</option>
                            <option value="null">69</option>
                            <option value="null">70</option>
                            <option value="null">71</option>
                            <option value="null">72</option>
                            <option value="null">73</option>
                            <option value="null">74</option>
                      ...
                      <div className="form_but1">
                        ...
                        <div className="col-sm-7 form_radios">
                          <input type="checkbox" className="radio_1" /> Single
                          &nbsp;&nbsp;
                          <input
                            type="checkbox"
                            className="radio_1"
                      ...
                      <div className="form_but1">
                        ...
                        <div className="col-sm-7 form_radios">
                          <input type="checkbox" className="radio_1" /> with
                          Photo &nbsp;&nbsp;
                          <input
                            type="checkbox"
                            className="radio_1"
                      ...
                      <div className="form_but1">
                        ...
                        <div className="col-sm-7 form_radios">
                          <input type="checkbox" className="radio_1" /> Ignored
                          Profiles &nbsp;&nbsp;
                          <input
                            type="checkbox"
                            className="radio_1"
                ...
                <div>
                  <div className="w3_regular_search">
                    <form action="#" method="post">
                      ...
                      <div className="agileits_advanced_Search">
                          ...
                          <div className="col-sm-7 form_radios">
                            <div className="select-block1">
                              <select>
                                ...
                                <option value="">
                                  Any Bachelors in Medicine in General / Dental
                                  / Surgeon
                                </option>
                                <option value="">
                                  Any Masters in Medicine in General / Dental /
                                  Surgeon
                                </option>
          ...
          <div className="col-md-3 w3ls-aside">
            ...
            <div className="fltr-w3ls">
              ...
              <ul>
                <li>
                  <a href="#">Profession1</a>
                </li>
                <li>
                  <a href="#">Profession2</a>
                </li>
                <li>
                  <a href="#">Profession3</a>
                </li>
                <li>
                  <a href="#">Profession4</a>
                </li>
                <li>
                  <a href="#">Profession5</a>
                </li>
                <li>
                  <a href="#">Profession6</a>
                </li>
              </ul>
            </div>
          </div>
